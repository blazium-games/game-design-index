...
[![Issues welcome](https://img.shields.io/badge/issues-welcome-blue.svg)](https://github.com/blazium-games/game-mechanics-index/issues)
[![PRs welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/blazium-games/game-mechanics-index/pulls)
...
| | |
|---|---|
| **Live site** | https://blazium-games.github.io/game-mechanics-index/ |
...
We actively welcome **missing games**, **corrections**, and **new mechanic definitions**. Open an [Issue](https://github.com/blazium-games/game-mechanics-index/issues/new/choose) or submit a PR.
...
| **GitHub Releases** | Pinned `mechanics-index-api-{version}.zip` |
