...
The Game Design Index exposes a **read-only static JSON API** served from GitHub Pages and versioned GitHub Releases.

## Base URLs

| Source | URL |
|--------|-----|
| Latest (Pages) | `https://blazium-games.github.io/game-design-index/api/v1/` |
| Multi-format export | [GitHub Releases](https://github.com/blazium-games/game-design-index/releases) (`design-index-formats-{version}.zip`) |
| Pinned release | `https://github.com/blazium-games/game-design-index/releases/download/v{version}/design-index-api-{version}.zip` |
