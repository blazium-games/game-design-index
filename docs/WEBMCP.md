...
The live site registers [WebMCP](https://github.com/webmachinelearning/webmcp) tools on `document.modelContext` so browser-integrated AI agents can query the game mechanics index with structured schemas.

## Quick start

1. Open [the live index](https://blazium-games.github.io/game-mechanics-index/).
...
```text
You are on the Game Mechanics Index. Use document.modelContext WebMCP tools (not HTML scraping).
...
curl -s https://blazium-games.github.io/game-mechanics-index/api/v1/mechanics/boss-weakness-network.json
...
```text
Game Mechanics Index — 1389 games, 248 mechanics, schema 1.2.
