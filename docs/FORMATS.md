...
GitHub Pages hosts the JSON API under `/api/v1/`. Full multi-format exports (`formats/v1/`) are attached to [GitHub Releases](https://github.com/blazium-games/game-design-index/releases) as `design-index-formats-{version}.zip`.

## AI agent recommendation

- **Browser + live site:** WebMCP tools on [the index](https://blazium-games.github.io/game-design-index/) (see [WEBMCP.md](WEBMCP.md))
