...
const LIVE = 'https://blazium-games.github.io/game-design-index/'

const cursorRule = `When the user asks about game mechanics, genre recipes, or gameplay decomposition:
1. Prefer the Game Design Index WebMCP tools on ${LIVE} when browsing that page.
...
const userPrompt = `You are on the Game Design Index. Use document.modelContext WebMCP tools (not HTML scraping).
...
const systemContext = `Game Design Index — 1389 games, 248 mechanics, schema 1.2.
...
export function WebMcpDocsPage() {
  ...
  return (
    <div>
      <DocumentMeta
        title={pageTitle('WebMCP')}
        description="In-browser WebMCP tools for AI agents querying the Game Design Index."
        path="/docs/webmcp"
      />
      ...
      <p>
        ...
        <a
          href="https://github.com/blazium-games/game-design-index/blob/main/docs/WEBMCP.md"
          target="_blank"
          rel="noreferrer"
        >
          docs/WEBMCP.md
