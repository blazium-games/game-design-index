  ...
  return (
    <>
      <section id="description">
        <SectionHeading sectionId="description">Description</SectionHeading>
      ...
      {map.context &&
        (map.context.dimension ||
          ...
          <section id="context">
            <SectionHeading sectionId="context">Context</SectionHeading>
            <ul>
      ...
      <section id="signatures">
        <SectionHeading sectionId="signatures">Signature mechanics</SectionHeading>
        <div className="chips">
      ...
      <section id="mechanics">
        <SectionHeading sectionId="mechanics">Mechanic bindings</SectionHeading>
        <table className="table">
          <thead>
            <tr>
              <th>Mechanic</th>
              <th>Role</th>
              {showPhase && <th>Phase</th>}
              <th>Domain</th>
              <th>Notes</th>
            </tr>
          </thead>
      ...
      <section id="variables">
        <SectionHeading sectionId="variables">Variable bindings</SectionHeading>
        {hasVars ? (
          <table className="table">
            <thead>
              <tr>
      ...
      <section id="ui-menus">
        <SectionHeading sectionId="ui-menus">UI menu bindings</SectionHeading>
        {hasMenus ? (
          <table className="table">
            <thead>
              <tr>
      ...
      {map.variable_relationships && map.variable_relationships.length > 0 && (
        <section id="variable-relationships">
          <SectionHeading sectionId="variable-relationships">Variable relationships</SectionHeading>
          <ul>
      ...
      {map.variants && map.variants.length > 0 && (
        <section id="variants">
          <SectionHeading sectionId="variants">Variants</SectionHeading>
          {map.variants.map((v) => (
      ...
      {map.views && map.views.length > 0 && (
        <section id="views">
          <SectionHeading sectionId="views">Map views</SectionHeading>
          <div className="chips">
            {map.views.map((v) => (
      ...
      {map.design_intent?.player_fantasy && (
        <section id="player-fantasy">
          <SectionHeading sectionId="player-fantasy">Player fantasy</SectionHeading>
      ...
      {map.design_intent?.design_pillars && map.design_intent.design_pillars.length > 0 && (
        <section id="design-pillars">
          <SectionHeading sectionId="design-pillars">Design pillars</SectionHeading>
          <ul>
      ...
      {map.systems &&
        (map.systems.failure_model ||
          ...
          map.systems.pacing) && (
          <section id="systems">
            <SectionHeading sectionId="systems">Systems</SectionHeading>
            {map.systems.failure_model && (
              <p>
      ...
      {map.gdd_outline && (
        <section id="gdd-outline">
          <SectionHeading sectionId="gdd-outline">GDD outline</SectionHeading>
