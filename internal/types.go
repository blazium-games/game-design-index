...
// SkillSchemaVersion is the design skills catalog version.
const SkillSchemaVersion = "1.0"
...
type MechanicEntry struct {
	...
	DesignExercises    []DesignExercise         `json:"design_exercises,omitempty"`
	SkillsDeveloped    []string                 `json:"skills_developed,omitempty"`
...
const (
	SkillMotor      SkillCategory = "motor"
	SkillCognitive  SkillCategory = "cognitive"
	SkillStrategic  SkillCategory = "strategic"
	SkillSocial     SkillCategory = "social"
	SkillCreative   SkillCategory = "creative"
)

type DesignSkill struct {
	SchemaVersion      string          `json:"schema_version"`
	Slug               string          `json:"slug"`
	Name               string          `json:"name"`
	Summary            string          `json:"summary"`
	...
	PracticeActivities []string        `json:"practice_activities,omitempty"`
	RelatedMechanics   []string        `json:"related_mechanics,omitempty"`
	RelatedVariables   []string        `json:"related_variables,omitempty"`
	DesignGuidance     *DesignGuidance `json:"design_guidance,omitempty"`
	Tags               []string        `json:"tags"`
...
type SkillsCatalog struct {
	SchemaVersion string        `json:"schema_version"`
	Skills        []DesignSkill `json:"skills"`
}
